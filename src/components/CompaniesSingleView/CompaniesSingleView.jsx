...
function SingleViewCompany() {
  ...
  React.useEffect(() => {
    dispatch(getOneSingleCompany(params.id))
      ...
      <div>
        {singleCompany.id ? (
          <div className={style.companySingleSection}>
            ...
            >
              <Fade in={open}>
                <div style={modalStyle} className={classes.paper}>
                  <h2>Total de Busquedas: {jobsCompany.length}</h2>
            ...
            <div className={style.singleCompanyDescription}>
              <div className={style.jobsCompanyContent}>
                <h2>Búsquedas activas</h2>
                <h2>Total: {activeJobs.length}</h2>
              </div>
