...
export const getAllAditionalData = createAsyncThunk(
  'GET_ALL_ADITIONAL_DATA',
  () => {
    ...
    const call6 = axios.get('/api/aditionalData/roles')
    ...
    return axios
      .all([call1, call2, call3, call4, call5, call6])
      .then(
        axios.spread((...responses) => {
          ...
          const roles = responses[5].data
          return { areas, states, seniorities, modalities, type, roles }
        })
      )
      .then((data) => data)
      .catch((err) => console.log(err))
